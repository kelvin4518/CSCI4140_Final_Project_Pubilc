...
public class OtherMissionFragment extends BaseFragment {

    private static final String TAG = "OtherMissionFrag";
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        mTitle = getString(R.string.other_mission_fragment_title);
        setPrevTitle(mTitle);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        View mView = inflater.inflate(R.layout.fragment_other_mission, container, false);
